...
This repo contains the MATLAB and Python scripts used to generate the figures in our paper:

Huang, Rui, & Howes, Gregory G. (2025). **Unveiling the Velocity-Space Signature of Ion Cyclotron Damping Using Liouville Mapping**. _arXiv preprint arXiv:2507.19436_. (Submitted to Physics of Plasmas)
