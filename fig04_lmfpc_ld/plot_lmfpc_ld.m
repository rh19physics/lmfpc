...
% title("$C_{E_\parallel}(v_\parallel, v_\perp)$ (arb. units)", ...
%     'Interpreter','latex', ...
%     'FontName','TimesNewRoman', ...
%     'FontSize', 32, ...
%     'FontWeight','bold');

title("$C_{E_\parallel}(v_\parallel, v_\perp)$", ...
    'Interpreter','latex', ...
    'FontName','TimesNewRoman', ...
    'FontSize', 32, ...
    'FontWeight','bold');
...
ylabel('$C_{E_\parallel}(v_\parallel)$','Interpreter','latex', ...
    'FontName', 'TimesNewRoman', ...
    'FontSize', 32, ...
    'FontWeight', 'bold');

% text(-2, max(tmpf_1DCez)*1.9, "(arb. units)", ...
%     'Interpreter','latex', 'VerticalAlignment','top', FontSize=32);
