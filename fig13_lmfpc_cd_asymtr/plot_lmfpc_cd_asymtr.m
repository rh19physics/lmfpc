...
% For all cases, set field_choice to -653 and t_init = - 4*waveT in set_params.m
    case 1 
        anno_labels = ["$(a)$", "$(b)$", "$(c)$", "$(d)$"];
        load("../lmfpc_matlab/data/iSHCDV21_20250524_185705.mat");
    case 2
        anno_labels = ["$(e)$", "$(f)$", "$(g)$", "$(h)$"];
        load("../lmfpc_matlab/data/iSHCDV21_20250524_185751.mat");
    case 3
        anno_labels = ["$(i)$", "$(j)$", "$(k)$", "$(l)$"];
        load("../lmfpc_matlab/data/iSHCDV21_20241118_131107.mat");
    case 4
        anno_labels = ["$(m)$", "$(n)$", "$(o)$", "$(p)$"];
        load("../lmfpc_matlab/data/iSHCDV21_20250524_185834.mat");
end
