...
switch(figure_number)
    case 1 % Set field_choice to -6301 and t_init to -9*waveT in set_params.m
        anno_labels = ["$(a)$", "$(b)$", "$(c)$", "$(d)$"];
        load("../lmfpc_matlab/data/iSHCDV21_20250106_210843.mat");
    case 2 % Set field_choice to -63 and t_init to -4*waveT in set_params.m
        anno_labels = ["$(e)$", "$(f)$", "$(g)$", "$(h)$"];
